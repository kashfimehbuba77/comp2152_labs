...
input("Roll for the 1st item (Press Enter)")
...
#lab-04 - Q06 - item 2
input("Roll for the 2nd item (Press Enter)")
lootRoll = random.choice(range(1, len(loot_options)+ 1))
loot = loot_options.pop(lootRoll-1)
belt.append(loot)
print("Your belt: ", belt)

#lab04 - Q07 - Sort the belt
print("You got the loots, so organize your belt alphabetically: ")
belt.sort()
print("Your belt: ", belt)

#lab04 - Q08 - Use the Belt
print("You see a Monster in the distance :O Quickly use your 1st item!!!")
...
print("Monster Combat Strength is now "+ str(combat_strength) + "using the " + power_roll + "Magic Power")
